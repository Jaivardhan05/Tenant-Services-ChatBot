...
/* Dataframes */
.stDataFrame { background-color: #161920 !important; }
...
# Sidebar (simplified)
st.sidebar.markdown("### Riverside Apartments")
...
with tabs[0]:
    ...
    with r2:
        st.markdown("""
        <div class='metric-card'>
          <div class='metric-label'>Building Alerts</div>
    ...
    st.markdown("<div class='section-header'>Amenity Hours</div>", unsafe_allow_html=True)
    import pandas as pd
    amenities = [
